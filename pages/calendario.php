...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="visualizarEvento">
                        ...
                        <button
                         style="background: transparent; border: 0px; font-size: 30px; color: #ff0000;"
                            type="button" style="color: red;" class="material-symbols-outlined" id="btnApagarEvento">
                            delete</button>
                    ...
                    <div id="editarEvento" style="display: none;">
                        ...
                        <form method="POST" id="formEditEvento">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="bolinhas col-sm-10 d-flex flex-wrap justify-content-between">
                                    ...
                                    <div style="width: 1px; height: 1px;" class="form-check form-check-inline">
                                        <input style="border: 0px; width: 0px; height: 0px; padding: 0px;"
                                            class="form-check-input" type="radio" name="edit_color" id="edit_color"
                                            value="#">
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input style="background-color: #040404;" class="form-check-input" type="radio"
                                            name="edit_color" id="edit_color_9" value="#040404">
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input style="background-color: #B6B5B5;" class="form-check-input" type="radio"
                                            name="edit_color" id="edit_color_10" value="#B6B5B5">
                                    </div>
                            ...
                            <button
                                style="margin-left: 80%; color: #8C52FF; background: transparent; border: 0px; font-size: 30px;"
    ...
    <!-- Modal Cadastrar -->
    <div class="modal fade modal-calendario" id="cadastrarModal" tabindex="-1" aria-labelledby="cadastrarModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="POST" id="formCadEvento">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="bolinhas col-sm-10 d-flex flex-wrap justify-content-between">
                                ...
                                <div class="form-check form-check-inline">
                                    <input style="background-color: #F95B99;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#F95B99">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #CB6CE6;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#CB6CE6">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #8C52FF;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#8C52FF">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #AA8DE4;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#AA8DE4">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #FF5757;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#FF5757">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #FF914D;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#FF914D">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #FFCF52;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#FFCF52">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #FFF178;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#FFF178">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #040404;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#040404">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #B6B5B5;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#B6B5B5">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #397D1D;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#397D1D">
                                </div>

                                <div class="form-check form-check-inline">
                                    <input style="background-color: #36DF32;" class="form-check-input" type="radio"
                                        name="cad_color" id="inlineRadio2" value="#36DF32">
                                </div>
                            </div>
                        </div>

                        <button onclick="refreshPage()"
                            style="margin-left: 90%; color: #8C52FF; background: transparent; border: 0px; font-size: 30px;"
